! function(t, e) {
    ...
    e(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', u._handleDismiss(new u)), e.fn[c] = u._jQueryInterface, e.fn[c].Constructor = u, e.fn[c].noConflict = function() {
        return e.fn[c] = h, u._jQueryInterface
    };
    var d = e.fn.button,
        f = function() {
            function t(t) {
    ...
    e(document).on("click.bs.button.data-api", '[data-toggle^="button"]', (function(t) {
        ...
        if (e(n).hasClass("btn") || (n = e(n).closest(".btn")[0]), !n || n.hasAttribute("disabled") || n.classList.contains("disabled")) t.preventDefault();
            ...
            "LABEL" === i.tagName && o && "checkbox" === o.type && t.preventDefault(), f._jQueryInterface.call(e(n), "toggle")
        }
        ...
        return e.fn.button = d, f._jQueryInterface
    };
    var g = "carousel",
        m = e.fn[g],
        p = {
        ...
        b = function() {
            ...
            return n.next = function() {
                ...
                return t = a(a({}, p), t), l.typeCheckConfig(g, t, _), t
    ...
    })), e.fn[g] = b._jQueryInterface, e.fn[g].Constructor = b, e.fn[g].noConflict = function() {
        return e.fn[g] = m, b._jQueryInterface
    };
    var y = "collapse",
        E = e.fn[y],
        w = {
        ...
        C = function() {
            ...
            return n.toggle = function() {
                ...
                return (t = a(a({}, w), t)).toggle = Boolean(t.toggle), l.typeCheckConfig(y, t, T), t
                ...
                return this.each((function() {
                    var i = e(this),
                        ...
                        s = a(a(a({}, w), i.data()), "object" == typeof n && n ? n : {});
    ...
    var S = "dropdown",
        ...
        I = function() {
            ...
            return i.toggle = function() {
                ...
                return t = a(a(a({}, this.constructor.Default), e(this._element).data()), t), l.typeCheckConfig(S, t, this.constructor.DefaultType), t
                ...
                if (!(/input|textarea/i.test(n.target.tagName) ? 32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || e(n.target).closest(".dropdown-menu").length) : !k.test(n.which)) && !this.disabled && !e(this).hasClass("disabled")) {
    ...
    e(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', I._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", I._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", I._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', (function(t) {
        ...
        return e.fn[S] = D, I._jQueryInterface
    };
    var O = e.fn.modal,
        j = {
            backdrop: !0,
        ...
        x = function() {
            ...
            return n.toggle = function(t) {
                ...
                return t = a(a({}, j), t), l.typeCheckConfig("modal", t, P), t
                ...
                return this.each((function() {
                    var o = e(this).data("bs.modal"),
                        s = a(a(a({}, j), e(this).data()), "object" == typeof n && n ? n : {});
    ...
    e(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', (function(t) {
        ...
        x._jQueryInterface.call(e(n), s, this)
    })), e.fn.modal = x._jQueryInterface, e.fn.modal.Constructor = x, e.fn.modal.noConflict = function() {
        return e.fn.modal = O, x._jQueryInterface
    };
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), o = Object.keys(e), s = [].slice.call(i.body.querySelectorAll("*")), r = function(t, n) {
                ...
                a.forEach((function(t) {
                    (function(t, e) {
                        ...
                        if (-1 !== e.indexOf(n)) return -1 === L.indexOf(n) || Boolean(t.nodeValue.match(R) || t.nodeValue.match(q));
            ...
            return i.enable = function() {
                ...
                if (e(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (e(i).removeClass("show"), "ontouchstart" in document.documentElement && e(document.body).children().off("mouseover", null, e.noop), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1, e(this.tip).hasClass("fade")) {
                        ...
                        e(i).one(l.TRANSITION_END, s).emulateTransitionEnd(r)
                    } else s();
                    this._hoverState = ""
                }
            }, i.update = function() {
                ...
                "object" != typeof n || !n.nodeType && !n.jquery ? this.config.html ? (this.config.sanitize && (n = F(n, this.config.whiteList, this.config.sanitizeFn)), t.html(n)) : t.text(n) : this.config.html ? e(n).parent().is(t) || t.empty().append(n) : t.text(e(n).text())
            }, i.getTitle = function() {
                ...
                return Object.keys(n).forEach((function(t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), l.typeCheckConfig(Q, t, this.constructor.DefaultType), t.sanitize && (t.template = F(t.template, t.whiteList, t.sanitizeFn)), t
    ...
    e.fn[Q] = K._jQueryInterface, e.fn[Q].Constructor = K, e.fn[Q].noConflict = function() {
        return e.fn[Q] = B, K._jQueryInterface
    };
    var X = "popover",
        Y = e.fn[X],
    ...
    e.fn[X] = tt._jQueryInterface, e.fn[X].Constructor = tt, e.fn[X].noConflict = function() {
        return e.fn[X] = Y, tt._jQueryInterface
    };
    var et = "scrollspy",
        nt = e.fn[et],
        it = {
        ...
        st = function() {
            ...
            return n.refresh = function() {
                ...
                if ("string" != typeof(t = a(a({}, it), "object" == typeof t && t ? t : {})).target && l.isElement(t.target)) {
                    var n = e(t.target).attr("id");
                    n || (n = l.getUID(et), e(t.target).attr("id", n)), t.target = "#" + n
                }
                return l.typeCheckConfig(et, t, ot), t
    ...
    e(window).on("load.bs.scrollspy.data-api", (function() {
        ...
        return e.fn[et] = nt, st._jQueryInterface
    };
    var rt = e.fn.tab,
        at = function() {
            function t(t) {
    ...
    var lt = e.fn.toast,
        ...
        ut = function() {
            ...
            return n.show = function() {
                ...
                return t = a(a(a({}, ht), e(this._element).data()), "object" == typeof t && t ? t : {}), l.typeCheckConfig("toast", t, this.constructor.DefaultType), t
    ...
    }, t.Alert = u, t.Button = f, t.Carousel = b, t.Collapse = C, t.Dropdown = I, t.Modal = x, t.Popover = tt, t.Scrollspy = st, t.Tab = at, t.Toast = ut, t.Tooltip = K, t.Util = l, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));