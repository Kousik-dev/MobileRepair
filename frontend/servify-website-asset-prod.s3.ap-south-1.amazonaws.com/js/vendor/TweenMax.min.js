        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(t, e, i) {
                ...
                n.version = "1.18.0", _.constructor = n, _.kill()._gc = !1, n.killTweensOf = n.killDelayedCallsTo = i.killTweensOf, n.getTweensOf = i.getTweensOf, n.lagSmoothing = i.lagSmoothing, n.ticker = i.ticker, n.render = i.render, _.invalidate = function() {
                    ...
                    for (h(t) || ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = s(t))), t = t || [], 0 > o && ((t = s(t)).reverse(), o *= -1), p = t.length - 1, m = 0; p >= m; m++) {
                        ...
                        d.delay = v, m === p && _ && (d.onComplete = T), y[m] = new n(t[m], e, d), v += o
                    }
                    return y
                ...
                var c = function(t, e) {
                        for (var s = [], r = 0, n = t._first; n;) n instanceof i ? s[r++] = n : (e && (s[r++] = n), r = (s = s.concat(c(n, e))).length), n = n._next;
                        return s
                    },
                ...
                var s = function(t) {
                    ...
                    m = s.prototype = new e;
                return s.version = "1.18.0", m.constructor = s, m.kill()._gc = m._forcingPlayhead = m._hasPause = !1, m.to = function(t, e, s, r) {
                    ...
                    var u, p, m = new s({
                        ...
                        g = r.cycle;
                    for ("string" == typeof t && (t = i.selector(t) || t), o(t = t || []) && (t = d(t)), 0 > (n = n || 0) && ((t = d(t)).reverse(), n *= -1), p = 0; t.length > p; p++)(u = c(r)).startAt && (u.startAt = c(u.startAt), u.startAt.cycle && f(u.startAt, t, p)), g && f(u, t, p), m.to(t[p], e, u, p * n);
                    return this.add(m, a)
                    ...
                    if (this._time !== f && this._first || i || l || u) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== f && t > 0 && (this._active = !0), 0 === f && this.vars.onStart && 0 !== this._time && (e || this._callback("onStart")), this._time >= f)
                            for (s = this._first; s && (a = s._next, !this._paused || m);)(s._active || s._startTime <= this._time && !s._paused && !s._gc) && (u === s && this.pause(), s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = a;
                        else
                        ...
                        this._onUpdate && (e || (h.length && _(), this._callback("onUpdate"))), o && (this._gc || (p === this._startTime || d !== this._timeScale) && (0 === this._time || c >= this.totalDuration()) && (n && (h.length && _(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[o] && this._callback(o)))
                    }
                ...
                return h.constructor = s, h.kill()._gc = !1, s.version = "1.18.0", h.invalidate = function() {
                    ...
                    if (t >= f) this._locked || (this._totalTime = f, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (n = !0, h = "onComplete", _ = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && (_ = !0, y > r && (h = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, this._yoyo && 0 != (1 & this._cycle) ? this._time = t = 0 : (this._time = p, t = p + 1e-4);
                        ...
                        if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== d || 0 === p && y !== r && (y > 0 || 0 > t && y >= 0) && !this._locked) && (h = "onReverseComplete", n = this._reversed), 0 > t) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (_ = n = !0, h = "onReverseComplete") : y >= 0 && this._first && (_ = !0), this._rawPrevTime = t;
                        else {
                    ...
                    if (this._cycle !== x && !this._locked) {
                        var b = this._yoyo && 0 != (1 & x),
                            ...
                            S = this._rawPrevTime,
                            k = this._time;
                        if (this._totalTime = x * p, x > this._cycle ? b = !b : this._totalTime += p, this._time = d, this._rawPrevTime = 0 === p ? y - 1e-4 : y, this._cycle = x, this._locked = !0, d = b ? 0 : p, this.render(d, e, 0 === p), e || this._gc || this.vars.onRepeat && this._callback("onRepeat"), w && (d = b ? p + 1e-4 : -1e-4, this.render(d, !0, !1)), this._locked = !1, this._paused && !T) return;
                    ...
                    if (this._time !== d && this._first || i || _ || c) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== m && t > 0 && (this._active = !0), 0 === m && this.vars.onStart && 0 !== this._totalTime && (e || this._callback("onStart")), this._time >= d)
                            ...
                            for (s = this._last; s && (l = s._prev, !this._paused || T);) {
                                if (s._active || d >= s._startTime && !s._paused && !s._gc) {
                                    if (c === s) {
                ...
                var h, _, u, c, f, p, d, m, g, v, y, T, x, b = t.length - 1,
                    w = 0,
                    P = t[0].a;
                for (h = 0; b > h; h++) _ = (f = t[w]).a, u = f.d, c = t[w + 1].d, l ? (y = e[h], x = .25 * ((T = i[h]) + y) * r / (a ? .5 : s[h] || .5), m = u - ((p = u - (u - _) * (a ? .5 * r : 0 !== y ? x / y : 0)) + (((d = u + (c - u) * (a ? .5 * r : 0 !== T ? x / T : 0)) - p) * (3 * y / (y + T) + .5) / 4 || 0))) : m = u - ((p = u - .5 * (u - _) * r) + (d = u + .5 * (c - u) * r)) / 2, p += m, d += m, f.c = g = p, f.b = 0 !== h ? P : P = f.a + .6 * (f.c - f.a), f.da = u - _, f.ca = g - _, f.ba = P - _, n ? (v = o(_, P, g, u), t.splice(w, 1, v[0], v[1], v[2], v[3]), w += 4) : w++, P = d;
                (f = t[w]).b = P, f.c = P + .4 * (f.d - P), f.da = f.d - f.a, f.ca = f.c - f.a, f.ba = P - f.a, n && (v = o(f.a, P, f.c, f.d), t.splice(w, 1, v[0], v[1], v[2], v[3]))
            }, h = function(t, s, r, n) {
                var o, l, h, _, u, c, f = [];
                if (n)
                    for (l = (t = [n].concat(t)).length; --l > -1;) "string" == typeof(c = t[l][s]) && "=" === c.charAt(1) && (t[l][s] = n[s] + Number(c.charAt(0) + c.substr(2)));
                ...
                var c, f, p, d, m, g, v, y, T = {},
                    x = [],
                    b = u || t[0];
                for (f in _ = "string" == typeof _ ? "," + _ + "," : ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,", null == n && (n = 1), t[0]) x.push(f);
                if (t.length > 1) {
                    for (y = t[t.length - 1], v = !0, c = x.length; --c > -1;)
                        if (f = x[c], Math.abs(b[f] - y[f]) > .05) {
                            v = !1;
                            break
                        }
                    v && (t = t.concat(), u && t.unshift(u), t.push(t[1]), u = t[t.length - 3])
                }
                for (e.length = i.length = s.length = 0, c = x.length; --c > -1;) f = x[c], r[f] = -1 !== _.indexOf("," + f + ","), T[f] = h(t, f, r[f], u);
                for (c = e.length; --c > -1;) e[c] = Math.sqrt(e[c]), i[c] = Math.sqrt(i[c]);
                if (!o) {
                    for (c = x.length; --c > -1;)
                        if (r[f])
                            for (g = (p = T[x[c]]).length - 1, d = 0; g > d; d++) m = p[d + 1].da / i[d] + p[d].da / e[d], s[d] = (s[d] || 0) + m * m;
                    for (c = s.length; --c > -1;) s[c] = Math.sqrt(s[c])
                }
                for (c = x.length, d = a ? 4 : 1; --c > -1;) p = T[f = x[c]], l(p, n, a, o, r[f]), v && (p.splice(0, d), p.splice(p.length - d, d));
                return T
            }, u = function(t, e, i) {
                ...
                for (h = v.length; --h > -1;) {
                    for (d[c = v[h]] = l = [], f = 0, u = t.length, _ = 0; u > _; _++) s = null == i ? t[_][c] : "string" == typeof(p = t[_][c]) && "=" === p.charAt(1) ? i[c] + Number(p.charAt(0) + p.substr(2)) : Number(p), g && _ > 1 && u - 1 > _ && (l[f++] = (s + l[f - 2]) / 2), l[f++] = s;
                    for (u = f - m + 1, f = 0, _ = 0; u > _; _ += m) s = l[_], r = l[_ + 1], n = l[_ + 2], o = 2 === m ? 0 : l[_ + 3], l[f++] = p = 3 === m ? new a(s, r, n, o) : new a(s, (2 * r + s) / 3, (2 * r + n) / 3, n);
                    l.length = f
                }
                return d
            }, c = function(t, e, i) {
                for (var s, r, n, a, o, l, h, _, u, c, f, p = 1 / i, d = t.length; --d > -1;)
                    for (n = (c = t[d]).a, a = c.d - n, o = c.c - n, l = c.b - n, s = r = 0, _ = 1; i >= _; _++) s = r - (r = ((h = p * _) * h * a + 3 * (u = 1 - h) * (h * o + u * l)) * h), e[f = d * i + _ - 1] = (e[f] || 0) + s * s
            }, f = function(t, e) {
                var i, s, r, n, a = [],
                    o = [],
                    l = 0,
                ...
                for (r = a.length, s = 0; r > s; s++) l += Math.sqrt(a[s]), f[n = s % e] = l, n === _ && (h += l, u[n = s / e >> 0] = f, o[n] = h, l = 0, f = []);
                return {
                    length: h,
                    lengths: o,
                    segments: u
                ...
                init: function(t, e, i) {
                    ...
                    if (p = this._autoRotate)
                        for (this._initialRotations = [], p[0] instanceof Array || (this._autoRotate = p = [p]), n = p.length; --n > -1;) {
                            ...
                            s = p[n][2], this._initialRotations[n] = this._func[s] ? this._func[s].call(this._target) : this._target[s]
                        }
                ...
                set: function(e) {
                    ...
                    for (s = 1 - o, r = this._props.length; --r > -1;) n = this._props[r], l = (o * o * (a = this._beziers[n][i]).da + 3 * s * (o * a.ca + s * a.ba)) * o + a.a, this._round[n] && (l = Math.round(l)), f[n] ? p[n](l) : p[n] = l;
                    if (this._autoRotate) {
                        var m, g, v, y, T, x, b, w = this._autoRotate;
                        for (r = w.length; --r > -1;) n = w[r][2], x = w[r][3] || 0, b = !0 === w[r][4] ? 1 : t, a = this._beziers[w[r][0]], m = this._beziers[w[r][1]], a && m && (a = a[i], m = m[i], g = a.a + (a.b - a.a) * o, g += ((y = a.b + (a.c - a.b) * o) - g) * o, y += (a.c + (a.d - a.c) * o - y) * o, v = m.a + (m.b - m.a) * o, v += ((T = m.b + (m.c - m.b) * o) - v) * o, T += (m.c + (m.d - m.c) * o - T) * o, l = d ? Math.atan2(T - v, y - g) * b + x : this._initialRotations[r], f[n] ? p[n](l) : p[n] = l)
                    }
                }
                ...
                var _, u, c, f, p, d, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                    ...
                    j = function() {
                        var t = B.indexOf("Android"),
                            e = N("a");
                        return c = -1 !== B.indexOf("Safari") && -1 === B.indexOf("Chrome") && (-1 === t || Number(B.substr(t + 8, 1)) > 3), p = c && 6 > Number(B.substr(B.indexOf("Version/") + 8, 1)), f = -1 !== B.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(B) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(B)) && (d = parseFloat(RegExp.$1)), !!e && (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity))
                    }(),
                    U = function(t) {
                    ...
                    Z = function(t, e) {
                        ...
                        return s >= 0 ? (q = "-" + (W = 3 === s ? "ms" : i[s]).toLowerCase() + "-", W + t) : null
                    },
                    G = X.defaultView ? X.defaultView.getComputedStyle : function() {},
                    $ = a.getStyle = function(t, e, i, s, r) {
                        var n;
                        return j || "opacity" !== e ? (!s && t.style[e] ? n = t.style[e] : (i = i || G(t)) ? n = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(O, "-$1").toLowerCase()) : t.currentStyle && (n = t.currentStyle[e]), null == r || n && "none" !== n && "auto" !== n && "auto auto" !== n ? n : r) : U(t)
                    },
                    Q = Y.convertToPixels = function(t, i, s, r, n) {
                        ...
                        if (f && (s = -s), "%" === r && -1 !== i.indexOf("border")) o = s / 100 * (_ ? t.clientWidth : t.clientHeight);
                            ...
                            if (c.cssText = "border:0 solid red;position:" + $(t, "position") + ";line-height:0;", "%" !== r && u.appendChild && "v" !== r.charAt(0) && "rem" !== r) c[_ ? "borderLeftWidth" : "borderTopWidth"] = s + r;
                            else {
                                if (l = (u = t.parentNode || X.body)._gsCache, h = e.ticker.frame, l && _ && l.time === h) return l.width * s / 100;
                                c[_ ? "width" : "height"] = s + r
                            }
                            u.appendChild(L), o = parseFloat(L[_ ? "offsetWidth" : "offsetHeight"]), u.removeChild(L), _ && "%" === r && !1 !== a.cacheWidths && ((l = u._gsCache = u._gsCache || {}).time = h, l.width = o / s * 100), 0 !== o || n || (o = Q(t, i, s, r, !0))
                        }
                        return f ? -o : o
                    },
                    ...
                    K = function(t, e) {
                        ...
                        if (e = e || G(t, null))
                            if (i = e.length)
                                for (; --i > -1;)(-1 === (r = e[i]).indexOf("-transform") || Ot === r) && (n[r.replace(S, R)] = e.getPropertyValue(r));
                            else
                                for (i in e)(-1 === i.indexOf("Transform") || Pt === i) && (n[i] = e[i]);
                        else if (e = t.currentStyle || t.style)
                            for (i in e) "string" == typeof i && void 0 === n[i] && (n[i.replace(S, R)] = e[i]);
                        return j || (n.opacity = U(t)), s = Nt(t, e, !1), n.rotation = s.rotation, n.skewX = s.skewX, n.scaleX = s.scaleX, n.scaleY = s.scaleY, n.x = s.x, n.y = s.y, kt && (n.z = s.z, n.rotationX = s.rotationX, n.rotationY = s.rotationY, n.scaleZ = s.scaleZ), n.filters && delete n.filters, n
                    },
                    ...
                    at = function(t, e, i, s) {
                        ...
                        return null == t ? o = e : "number" == typeof t ? o = t : (r = 360, n = t.split("_"), a = ((l = "=" === t.charAt(1)) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(n[0].substr(2)) : parseFloat(n[0])) * (-1 === t.indexOf("rad") ? 1 : F) - (l ? 0 : e), n.length && (s && (s[i] = e + a), -1 !== t.indexOf("short") && ((a %= r) !== a % 180 && (a = 0 > a ? a + r : a - r)), -1 !== t.indexOf("_cw") && 0 > a ? a = (a + 9999999999 * r) % r - (0 | a / r) * r : -1 !== t.indexOf("ccw") && a > 0 && (a = (a - 9999999999 * r) % r - (0 | a / r) * r)), o = e + a), h > o && o > -h && (o = 0), o
                    },
                    ot = {
                        aqua: [0, 255, 255],
                        lime: [0, 255, 0],
                    ...
                    ht = a.parseColor = function(t, e) {
                        ...
                        if (t)
                            if ("number" == typeof t) i = [t >> 16, 255 & t >> 8, 255 & t];
                                ...
                                else if ("#" === t.charAt(0)) 4 === t.length && (s = t.charAt(1), r = t.charAt(2), n = t.charAt(3), t = "#" + s + s + r + r + n + n), i = [(t = parseInt(t.substr(1), 16)) >> 16, 255 & t >> 8, 255 & t];
                                else if ("hsl" === t.substr(0, 3))
                                    if (i = c = t.match(m), e) {
                                        if (-1 !== t.indexOf("=")) return t.match(g)
                                    } else a = Number(i[0]) % 360 / 360, o = Number(i[1]) / 100, s = 2 * (l = Number(i[2]) / 100) - (r = .5 >= l ? l * (o + 1) : l + o - l * o), i.length > 3 && (i[3] = Number(t[3])), i[0] = lt(a + 1 / 3, s, r), i[1] = lt(a, s, r), i[2] = lt(a - 1 / 3, s, r);
                                else i = t.match(m) || ot.transparent;
                                i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), i.length > 3 && (i[3] = Number(i[3]))
                            }
                        else i = ot.black;
                        return e && !c && (s = i[0] / 255, r = i[1] / 255, n = i[2] / 255, l = ((h = Math.max(s, r, n)) + (_ = Math.min(s, r, n))) / 2, h === _ ? a = o = 0 : (u = h - _, o = l > .5 ? u / (2 - h - _) : u / (h + _), a = h === s ? (r - n) / u + (n > r ? 6 : 0) : h === r ? (n - s) / u + 2 : (s - r) / u + 4, a *= 60), i[0] = 0 | a + .5, i[1] = 0 | 100 * o + .5, i[2] = 0 | 100 * l + .5), i
                    },
                    _t = function(t, e) {
                        var i, s, r, n = t.match(ut) || [],
                            a = 0,
                            o = n.length ? "" : t;
                        for (i = 0; n.length > i; i++) s = n[i], a += (r = t.substr(a, t.indexOf(s, a) - a)).length + s.length, 3 === (s = ht(s, e)).length && s.push(1), o += r + (e ? "hsla(" + s[0] + "," + s[1] + "%," + s[2] + "%," + s[3] : "rgba(" + s.join(",")) + ")";
                        return o
                    },
                    ut = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#.+?\\b";
                for (h in ot) ut += "|" + h + "\\b";
                ut = RegExp(ut + ")", "gi"), a.colorStringFilter = function(t) {
                    var e, i = t[0] + t[1];
                    ut.lastIndex = 0, ut.test(i) && (e = -1 !== i.indexOf("hsl(") || -1 !== i.indexOf("hsla("), t[0] = _t(t[0], e), t[1] = _t(t[1], e))
                ...
                var ct = function(t, e, i, s) {
                        ...
                        return _ ? r = e ? function(t) {
                            ...
                            if (e = (t.match(ut) || [n])[0], f = (c = t.split(e).join("").match(v) || []).length, _ > f--)
                    ...
                    dt = (Y._parseToProxy = function(t, e, i, s, r, n) {
                        ...
                        for (i._transform = null, I = e, s = _ = i.parse(t, e, s, r), I = d, n && (i._transform = p, u && (u._prev = null, u._prev && (u._prev._next = null))); s && s !== u;) {
                            if (1 >= s.type && (f[o = s.p] = s.s + s.c, c[o] = s.s, n || (h = new pt(s, "s", o, h, s.r), s.c = 0), 1 === s.type))
                                for (a = s.l; --a > 0;) l = "xn" + a, f[o = s.p + "_" + l] = s.data[l], c[o] = s[l], n || (h = new pt(s, l, o, h, s.rxp[l]));
                            s = s._next
                        }
                        return {
                            proxy: c,
                        ...
                        this.t = t, this.p = e, this.s = s, this.c = r, this.n = l || e, t instanceof dt || n.push(this.n), this.r = h, this.type = o || 0, _ && (this.pr = _, i = !0), this.b = void 0 === u ? s : u, this.e = void 0 === c ? s + r : c, a && (this._next = a, a._prev = this)
                    }),
                    ...
                    gt = a.parseComplex = function(t, e, i, s, r, n, a, o, l, h) {
                        a = new dt(t, e, 0, 0, a, h ? 2 : 1, null, !1, o, i = i || n || "", s), s += "";
                        var u, c, f, p, d, v, y, T, x, b, w, P, O, S = i.split(", ").join(",").split(" "),
                            k = s.split(", ").join(",").split(" "),
                            R = S.length,
                            A = !1 !== _;
                        for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (S = S.join(" ").replace(M, ", ").split(" "), k = k.join(" ").replace(M, ", ").split(" "), R = S.length), R !== k.length && (R = (S = (n || "").split(" ")).length), a.plugin = l, a.setRatio = h, ut.lastIndex = 0, u = 0; R > u; u++)
                            if (p = S[u], d = k[u], (T = parseFloat(p)) || 0 === T) a.appendXtra("", T, rt(d, T), d.replace(g, ""), A && -1 !== d.indexOf("px"), !0);
                            else if (r && ut.test(p)) P = "," === d.charAt(d.length - 1) ? ")," : ")", O = -1 !== d.indexOf("hsl") && j, p = ht(p, O), d = ht(d, O), (x = p.length + d.length > 6) && !j && 0 === d[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(k[u]).join("transparent")) : (j || (x = !1), O ? a.appendXtra(x ? "hsla(" : "hsl(", p[0], rt(d[0], p[0]), ",", !1, !0).appendXtra("", p[1], rt(d[1], p[1]), "%,", !1).appendXtra("", p[2], rt(d[2], p[2]), x ? "%," : "%" + P, !1) : a.appendXtra(x ? "rgba(" : "rgb(", p[0], d[0] - p[0], ",", !0, !0).appendXtra("", p[1], d[1] - p[1], ",", !0).appendXtra("", p[2], d[2] - p[2], x ? "," : P, !0), x && (p = 4 > p.length ? 1 : p[3], a.appendXtra("", p, (4 > d.length ? 1 : d[3]) - p, P, !1))), ut.lastIndex = 0;
                        else if (v = p.match(m)) {
                            if (!(y = d.match(g)) || y.length !== v.length) return a;
                            for (f = 0, c = 0; v.length > c; c++) w = v[c], b = p.indexOf(w, f), a.appendXtra(p.substr(f, b - f), Number(w), rt(y[c], w), "", A && "px" === p.substr(b + w.length, 2), 0 === c), f = b + w.length;
                            a["xs" + a.l] += p.substr(f)
                    ...
                    vt = 9;
                for ((h = dt.prototype).l = h.pr = 0; --vt > 0;) h["xn" + vt] = 0, h["xs" + vt] = "";
                h.xs0 = "", h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null, h.appendXtra = function(t, e, i, s, r, n) {
                    var a = this,
                        o = a.l;
                    return a["xs" + o] += n && o ? " " + t : t || "", i || 0 === o || a.plugin ? (a.l++, a.type = a.setRatio ? 2 : 1, a["xs" + a.l] = s || "", o > 0 ? (a.data["xn" + o] = e + i, a.rxp["xn" + o] = r, a["xn" + o] = e, a.plugin || (a.xfirst = new dt(a, "xn" + o, e, i, a.xfirst || a, 0, a.n, r, a.pr), a.xfirst.xs0 = 0), a) : (a.data = {
                        s: e + i
                    }, a.rxp = {}, a.s = e, a.c = i, a.r = r, a)) : (a["xs" + o] += e + (s || ""), a)
                };
                var yt = function(t, e) {
                        e = e || {}, this.p = e.prefix && Z(t) || t, l[t] = l[this.p] = this, this.format = e.formatter || ct(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0
                    },
                ...
                (h = yt.prototype).parseComplex = function(t, e, i, s, r, n) {
                    ...
                    if (this.multi && (M.test(i) || M.test(e) ? (o = e.replace(M, "|").split("|"), l = i.replace(M, "|").split("|")) : c && (o = [e], l = [i])), l) {
                        for (h = l.length > o.length ? l.length : o.length, a = 0; h > a; a++) e = o[a] = o[a] || this.dflt, i = l[a] = l[a] || this.dflt, c && ((_ = e.indexOf(c)) !== (u = i.indexOf(c)) && (-1 === u ? o[a] = o[a].split(c).join("") : -1 === _ && (o[a] += " " + c)));
                        e = o.join(", "), i = l.join(", ")
                    }
                ...
                var bt, wt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Rt = Y.Transform = function() {
                        this.perspective = parseFloat(a.defaultTransformPerspective) || 0, this.force3D = !(!1 === a.defaultForce3D || !kt) && (a.defaultForce3D || "auto")
                    },
                    ...
                    Mt = function() {
                        ...
                        return X.createElementNS && !s && (t = Ct("svg", Dt), i = (e = Ct("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        })).getBoundingClientRect().width, e.style[St] = "50% 50%", e.style[Pt] = "scaleX(0.5)", s = i === e.getBoundingClientRect().width && !(f && kt), Dt.removeChild(t)), s
                    }(),
                    zt = function(t, e, i, s, r) {
                        var n, o, l, h, _, u, c, f, p, d, m, g, v, y, T = t._gsTransform,
                            x = Xt(t, !0);
                        T && (v = T.xOrigin, y = T.yOrigin), (!s || 2 > (n = s.split(" ")).length) && (c = t.getBBox(), n = [(-1 !== (e = st(e).split(" "))[0].indexOf("%") ? parseFloat(e[0]) / 100 * c.width : parseFloat(e[0])) + c.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * c.height : parseFloat(e[1])) + c.y]), i.xOrigin = h = parseFloat(n[0]), i.yOrigin = _ = parseFloat(n[1]), s && x !== It && (u = x[0], c = x[1], f = x[2], p = x[3], d = x[4], o = h * (p / (g = u * p - c * f)) + _ * (-f / g) + (f * (m = x[5]) - p * d) / g, l = h * (-c / g) + _ * (u / g) - (u * m - c * d) / g, h = i.xOrigin = n[0] = o, _ = i.yOrigin = n[1] = l), T && (r || !1 !== r && !1 !== a.defaultSmoothOrigin ? (o = h - v, l = _ - y, T.xOffset += o * x[0] + l * x[2] - o, T.yOffset += o * x[1] + l * x[3] - l) : T.xOffset = T.yOffset = 0), t.setAttribute("data-svg-origin", n.join(" "))
                    },
                    Ft = function(t) {
                    ...
                    Xt = function(t, e) {
                        var i, s, r, n, a, o = t._gsTransform || new Rt,
                            l = 1e5;
                        if (Pt ? s = $(t, Ot, null, !0) : t.currentStyle && (s = (s = t.currentStyle.filter.match(C)) && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), o.x || 0, o.y || 0].join(",") : ""), i = !s || "none" === s || "matrix(1, 0, 0, 1, 0, 0)" === s, (o.svg || t.getBBox && Ft(t)) && (i && -1 !== (t.style[Pt] + "").indexOf("matrix") && (s = t.style[Pt], i = 0), r = t.getAttribute("transform"), i && r && (-1 !== r.indexOf("matrix") ? (s = r, i = 0) : -1 !== r.indexOf("translate") && (s = "matrix(1,0,0,1," + r.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return It;
                        for (r = (s || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], vt = r.length; --vt > -1;) n = Number(r[vt]), r[vt] = (a = n - (n |= 0)) ? (0 | a * l + (0 > a ? -.5 : .5)) / l + n : n;
                        return e && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r
                    },
                    Nt = Y.getTransform = function(t, i, s, n) {
                        if (t._gsTransform && s && !n) return t._gsTransform;
                        var o, l, h, _, u, c, f = s && t._gsTransform || new Rt,
                            p = 0 > f.scaleX,
                            d = 2e-5,
                            m = 1e5,
                            g = kt && (parseFloat($(t, St, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin) || 0,
                            v = parseFloat(a.defaultTransformPerspective) || 0;
                        if (f.svg = !(!t.getBBox || !Ft(t)), f.svg && (zt(t, $(t, St, r, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), bt = a.useSVGTransformAttr || Mt), (o = Xt(t)) !== It) {
                            if (16 === o.length) {
                                var y, T, x, b, w, P = o[0],
                                    O = o[1],
                                    S = o[2],
                                    ...
                                    E = o[11],
                                    Y = Math.atan2(C, I);
                                f.zOrigin && (X = M * (L = -f.zOrigin) - o[12], N = z * L - o[13], L = I * L + f.zOrigin - o[14]), f.rotationX = Y * F, Y && (y = R * (b = Math.cos(-Y)) + M * (w = Math.sin(-Y)), T = A * b + z * w, x = C * b + I * w, M = R * -w + M * b, z = A * -w + z * b, I = C * -w + I * b, E = D * -w + E * b, R = y, A = T, C = x), Y = Math.atan2(M, I), f.rotationY = Y * F, Y && (T = O * (b = Math.cos(-Y)) - z * (w = Math.sin(-Y)), x = S * b - I * w, z = O * w + z * b, I = S * w + I * b, E = k * w + E * b, P = y = P * b - M * w, O = T, S = x), Y = Math.atan2(O, P), f.rotation = Y * F, Y && (P = P * (b = Math.cos(-Y)) + R * (w = Math.sin(-Y)), T = O * b + A * w, A = O * -w + A * b, C = S * -w + C * b, O = T), f.rotationX && Math.abs(f.rotationX) + Math.abs(f.rotation) > 359.9 && (f.rotationX = f.rotation = 0, f.rotationY += 180), f.scaleX = (0 | Math.sqrt(P * P + O * O) * m + .5) / m, f.scaleY = (0 | Math.sqrt(A * A + z * z) * m + .5) / m, f.scaleZ = (0 | Math.sqrt(C * C + I * I) * m + .5) / m, f.skewX = 0, f.perspective = E ? 1 / (0 > E ? -E : E) : 0, f.x = X, f.y = N, f.z = L, f.svg && (f.x -= f.xOrigin - (f.xOrigin * P - f.yOrigin * R), f.y -= f.yOrigin - (f.yOrigin * O - f.xOrigin * A))
                            } else if (!(kt && !n && o.length && f.x === o[4] && f.y === o[5] && (f.rotationX || f.rotationY) || void 0 !== f.x && "none" === $(t, "display", i))) {
                                var B = o.length >= 6,
                                    j = B ? o[0] : 1,
                                    U = o[1] || 0,
                                    V = o[2] || 0,
                                    q = B ? o[3] : 1;
                                f.x = o[4] || 0, f.y = o[5] || 0, h = Math.sqrt(j * j + U * U), _ = Math.sqrt(q * q + V * V), u = j || U ? Math.atan2(U, j) * F : f.rotation || 0, c = V || q ? Math.atan2(V, q) * F + u : f.skewX || 0, Math.abs(c) > 90 && 270 > Math.abs(c) && (p ? (h *= -1, c += 0 >= u ? 180 : -180, u += 0 >= u ? 180 : -180) : (_ *= -1, c += 0 >= c ? 180 : -180)), f.scaleX = h, f.scaleY = _, f.rotation = u, f.skewX = c, kt && (f.rotationX = f.rotationY = f.z = 0, f.perspective = v, f.scaleZ = 1), f.svg && (f.x -= f.xOrigin - (f.xOrigin * j + f.yOrigin * V), f.y -= f.yOrigin - (f.xOrigin * U + f.yOrigin * q))
                            }
                            for (l in f.zOrigin = g, f) d > f[l] && f[l] > -d && (f[l] = 0)
                        }
                    ...
                    Et = Y.set3DTransformRatio = Y.setTransformRatio = function(t) {
                        var e, i, s, r, n, a, o, l, h, _, u, c, p, d, m, g, v, y, T, x, b, w, P, O = this.data,
                            S = this.t.style,
                            k = O.rotation,
                            R = O.rotationX,
                            A = O.rotationY,
                            ...
                            L = O.perspective,
                            E = O.force3D;
                        if (!((1 !== t && 0 !== t || "auto" !== E || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && E || X || L || A || R) || bt && N || !kt) k || O.skewX || N ? (k *= z, w = O.skewX * z, P = 1e5, e = Math.cos(k) * C, r = Math.sin(k) * C, i = Math.sin(k - w) * -D, n = Math.cos(k - w) * D, w && "simple" === O.skewType && (v = Math.tan(w), i *= v = Math.sqrt(1 + v * v), n *= v, O.skewY && (e *= v, r *= v)), N && (F += O.xOrigin - (O.xOrigin * e + O.yOrigin * i) + O.xOffset, I += O.yOrigin - (O.xOrigin * r + O.yOrigin * n) + O.yOffset, bt && (O.xPercent || O.yPercent) && (d = this.t.getBBox(), F += .01 * O.xPercent * d.width, I += .01 * O.yPercent * d.height), (d = 1e-6) > F && F > -d && (F = 0), d > I && I > -d && (I = 0)), T = (0 | e * P) / P + "," + (0 | r * P) / P + "," + (0 | i * P) / P + "," + (0 | n * P) / P + "," + F + "," + I + ")", N && bt ? this.t.setAttribute("transform", "matrix(" + T) : S[Pt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + T) : S[Pt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + C + ",0,0," + D + "," + F + "," + I + ")";
                        else {
                            if (f && ((d = 1e-4) > C && C > -d && (C = M = 2e-5), d > D && D > -d && (D = M = 2e-5), !L || O.z || O.rotationX || O.rotationY || (L = 0)), k || O.skewX) k *= z, m = e = Math.cos(k), g = r = Math.sin(k), O.skewX && (k -= O.skewX * z, m = Math.cos(k), g = Math.sin(k), "simple" === O.skewType && (v = Math.tan(O.skewX * z), m *= v = Math.sqrt(1 + v * v), g *= v, O.skewY && (e *= v, r *= v))), i = -g, n = m;
                            else {
                                if (!(A || R || 1 !== M || L || N)) return void(S[Pt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) translate3d(" : "translate3d(") + F + "px," + I + "px," + X + "px)" + (1 !== C || 1 !== D ? " scale(" + C + "," + D + ")" : ""));
                                e = n = 1, i = r = 0
                            }
                            h = 1, s = a = o = l = _ = u = 0, c = L ? -1 / L : 0, p = O.zOrigin, d = 1e-6, x = ",", b = "0", (k = A * z) && (m = Math.cos(k), o = -(g = Math.sin(k)), _ = c * -g, s = e * g, a = r * g, h = m, c *= m, e *= m, r *= m), (k = R * z) && (v = i * (m = Math.cos(k)) + s * (g = Math.sin(k)), y = n * m + a * g, l = h * g, u = c * g, s = i * -g + s * m, a = n * -g + a * m, h *= m, c *= m, i = v, n = y), 1 !== M && (s *= M, a *= M, h *= M, c *= M), 1 !== D && (i *= D, n *= D, l *= D, u *= D), 1 !== C && (e *= C, r *= C, o *= C, _ *= C), (p || N) && (p && (F += s * -p, I += a * -p, X += h * -p + p), N && (F += O.xOrigin - (O.xOrigin * e + O.yOrigin * i) + O.xOffset, I += O.yOrigin - (O.xOrigin * r + O.yOrigin * n) + O.yOffset), d > F && F > -d && (F = b), d > I && I > -d && (I = b), d > X && X > -d && (X = 0)), T = O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix3d(" : "matrix3d(", T += (d > e && e > -d ? b : e) + x + (d > r && r > -d ? b : r) + x + (d > o && o > -d ? b : o), T += x + (d > _ && _ > -d ? b : _) + x + (d > i && i > -d ? b : i) + x + (d > n && n > -d ? b : n), R || A ? (T += x + (d > l && l > -d ? b : l) + x + (d > u && u > -d ? b : u) + x + (d > s && s > -d ? b : s), T += x + (d > a && a > -d ? b : a) + x + (d > h && h > -d ? b : h) + x + (d > c && c > -d ? b : c) + x) : T += ",0,0,0,0,1,0,", T += F + x + I + x + X + x + (L ? 1 + -X / L : 1) + ")", S[Pt] = T
                        }
                    };
                (h = Rt.prototype).x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, Tt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                    ...
                    parser: function(t, e, i, s, n, a) {
                        var o, l, h, _, u, c, f = "background-position",
                            ...
                            g = this.format(e);
                        if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && ((c = $(t, "backgroundImage").replace(k, "")) && "none" !== c)) {
                            for (o = m.split(" "), l = g.split(" "), E.setAttribute("src", c), h = 2; --h > -1;)(_ = -1 !== (m = o[h]).indexOf("%")) !== (-1 !== l[h].indexOf("%")) && (u = 0 === h ? t.offsetWidth - E.width : t.offsetHeight - E.height, o[h] = _ ? parseFloat(m) / 100 * u + "px" : parseFloat(m) / u * 100 + "%");
                            m = o.join(" ")
                        }
                ...
                var Yt = function(t) {
                    var e, i = this.t,
                        ...
                        r = 0 | this.s + this.c * t;
                    100 === r && (-1 === s.indexOf("atrix(") && -1 === s.indexOf("radient(") && -1 === s.indexOf("oader(") ? (i.removeAttribute("filter"), e = !$(this.data, "filter")) : (i.filter = s.replace(w, ""), e = !0)), e || (this.xn1 && (i.filter = s = s || "alpha(opacity=" + r + ")"), -1 === s.indexOf("pacity") ? 0 === r && this.xn1 || (i.filter = s + " alpha(opacity=" + r + ")") : i.filter = s.replace(x, "opacity=" + r))
                };
                Tt("opacity,alpha,autoAlpha", {
                    ...
                    parser: function(t, e, i, s, n, a) {
                        var o = parseFloat($(t, "opacity", r, !1, "1")),
                            l = t.style,
                            h = "autoAlpha" === i;
                        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + o), h && 1 === o && "hidden" === $(t, "visibility", r) && 0 !== e && (o = 0), j ? n = new dt(l, "opacity", o, e - o, n) : ((n = new dt(l, "opacity", 100 * o, 100 * (e - o), n)).xn1 = h ? 1 : 0, l.zoom = 1, n.type = 2, n.b = "alpha(opacity=" + n.s + ")", n.e = "alpha(opacity=" + (n.s + n.c) + ")", n.data = t, n.plugin = a, n.setRatio = Yt), h && ((n = new dt(l, "visibility", 0, 0, n, -1, null, !1, 0, 0 !== o ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")).xs0 = "inherit", s._overwriteProps.push(n.n), s._overwriteProps.push(i)), n
                    }
                });
                var Bt = function(t, e) {
                ...
                Tt("className", {
                    parser: function(t, e, s, n, a, o, l) {
                        var h, _, u, c, f, p = t.getAttribute("class") || "",
                            d = t.style.cssText;
                        if ((a = n._classNamePT = new dt(t, s, 0, 0, a, 2)).setRatio = jt, a.pr = -11, i = !0, a.b = p, _ = K(t, r), u = t._gsClassPT) {
                            for (c = {}, f = u.data; f;) c[f.p] = 1, f = f._next;
                            u.setRatio(1)
                        }
                        return t._gsClassPT = a, a.e = "=" !== e.charAt(1) ? e : p.replace(RegExp("\\s*\\b" + e.substr(2) + "\\b"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), t.setAttribute("class", a.e), h = J(t, _, K(t), l, c), t.setAttribute("class", p), a.data = h.firstMPT, t.style.cssText = d, a.xfirst = n.parse(t, h.difs, a, o)
                    }
                });
                var Ut = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) a.cssText = "", r = !0;
                            ...
                            for (s = (e = this.e.split(" ").join("").split(",")).length; --s > -1;) i = e[s], l[i] && (l[i].parse === o ? r = !0 : i = "transformOrigin" === i ? St : l[i].p), Bt(a, i);
                        r && (Bt(a, Pt), (n = this.t._gsTransform) && (n.svg && this.t.removeAttribute("data-svg-origin"), delete this.t._gsTransform))
                    }
                };
                for (Tt("clearProps", {
                        parser: function(t, e, s, r, n) {
                            return (n = new dt(t, s, 0, 0, n, 2)).setRatio = Ut, n.e = e, n.pr = -10, n.data = r._tween, i = !0, n
                        }
                ...
                (h = a.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, o) {
                    ...
                    var h, f, d, m, g, v, y, T, x, w = t.style;
                    if (u && "" === w.zIndex && (("auto" === (h = $(t, "zIndex", r)) || "" === h) && this._addLazySet(w, "zIndex", 0)), "string" == typeof e && (m = w.cssText, h = K(t, r), w.cssText = m + ";" + e, h = J(t, h, K(t)).difs, !j && b.test(e) && (h.opacity = parseFloat(RegExp.$1)), e = h, w.cssText = m), this._firstPT = f = e.className ? l.className.parse(t, e.className, "className", this, null, null, e) : this.parse(t, e, null), this._transformType) {
                        for (x = 3 === this._transformType, Pt ? c && (u = !0, "" === w.zIndex && (("auto" === (y = $(t, "zIndex", r)) || "" === y) && this._addLazySet(w, "zIndex", 0)), p && this._addLazySet(w, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) : w.zoom = 1, d = f; d && d._next;) d = d._next;
                        T = new dt(t, "transform", 0, 0, null, 2), this._linkCSSP(T, null, d), T.setRatio = Pt ? Et : Lt, T.data = this._transform || Nt(t, r, !0), T.tween = o, T.pr = -1, n.pop()
                    }
                    if (i) {
                        for (; f;) {
                    ...
                    for (a in e) f = e[a], (o = l[a]) ? i = o.parse(t, f, a, this, i, n, e) : (c = $(t, a, r) + "", m = "string" == typeof f, "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || m && P.test(f) ? (m || (f = ((f = ht(f)).length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")"), i = gt(v, a, c, f, !0, "transparent", i, 0, n)) : !m || -1 === f.indexOf(" ") && -1 === f.indexOf(",") ? (p = (h = parseFloat(c)) || 0 === h ? c.substr((h + "").length) : "", ("" === c || "auto" === c) && ("width" === a || "height" === a ? (h = it(t, a, r), p = "px") : "left" === a || "top" === a ? (h = H(t, a, r), p = "px") : (h = "opacity" !== a ? 0 : 1, p = "")), (g = m && "=" === f.charAt(1)) ? (u = parseInt(f.charAt(0) + "1", 10), f = f.substr(2), u *= parseFloat(f), d = f.replace(T, "")) : (u = parseFloat(f), d = m ? f.replace(T, "") : ""), "" === d && (d = a in s ? s[a] : p), f = u || 0 === u ? (g ? u + h : u) + d : e[a], p !== d && "" !== d && (u || 0 === u) && h && (h = Q(t, a, h, p), "%" === d ? (h /= Q(t, a, 100, "%") / 100, !0 !== e.strictUnits && (c = h + "%")) : "em" === d || "rem" === d ? h /= Q(t, a, 1, d) : "px" !== d && (u = Q(t, a, u, d), d = "px"), g && (u || 0 === u) && (f = u + h + d)), g && (u += h), !h && 0 !== h || !u && 0 !== u ? void 0 !== v[a] && (f || "NaN" != f + "" && null != f) ? (i = new dt(v, a, u || h || 0, 0, i, -1, a, !1, 0, c, f)).xs0 = "none" !== f || "display" !== a && -1 === a.indexOf("Style") ? f : c : V("invalid " + a + " tween value: " + e[a]) : (i = new dt(v, a, h, u - h, i, 0, a, !1 !== _ && ("px" === d || "zIndex" === a), 0, c, f)).xs0 = d) : i = gt(v, a, c, f, !0, null, i, 0, n)), n && i && !i.plugin && (i.plugin = n);
                    return i
                    ...
                    this._transform = this._transform || Nt(this._target, r, !0), this._transformType = this._transform.svg && bt || !t && 3 !== this._transformType ? 2 : 3
                };
                var Vt = function() {
                ...
                var qt = function(t, e, i) {
                    ...
                    if (t.slice)
                        ...
                        for (r = (s = t.childNodes).length; --r > -1;) a = (n = s[r]).type, n.style && (e.push(K(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || qt(n, e, i)
                };
                return a.cascadeTo = function(t, i, s) {
                    ...
                    for (t = l._targets || l.target, qt(t, _, c), l.render(i, !0, !0), qt(t, u), l.render(0, !0, !0), l._enabled(!0), r = c.length; --r > -1;)
            ...
            function() {
                ...
                init: function(t, e) {
                    ...
                    var i, s, r, n, a, o = !0 === e.useRadians ? 2 * Math.PI : 360,
                        l = 1e-6;
                    for (i in e) "useRadians" !== i && (s = (a = (e[i] + "").split("_"))[0], r = parseFloat("function" != typeof t[i] ? t[i] : t[i.indexOf("set") || "function" != typeof t["get" + i.substr(3)] ? i : "get" + i.substr(3)]()), n = (this.finals[i] = "string" == typeof s && "=" === s.charAt(1) ? r + parseInt(s.charAt(0) + "1", 10) * Number(s.substr(2)) : Number(s) || 0) - r, a.length && (-1 !== (s = a.join("_")).indexOf("short") && ((n %= o) !== n % (o / 2) && (n = 0 > n ? n + o : n - o)), -1 !== s.indexOf("_cw") && 0 > n ? n = (n + 9999999999 * o) % o - (0 | n / o) * o : -1 !== s.indexOf("ccw") && n > 0 && (n = (n - 9999999999 * o) % o - (0 | n / o) * o)), (n > l || -l > n) && (this._addTween(t, i, r, r + n, i), this._overwriteProps.push(i)));
                    return !0
                },
                set: function(t) {
                    var e;
        ...
        if (!i.TweenLite) {
            var s, r, n, a, o, l = function(t) {
                ...
                d = function(e, s, r, n) {
                    ...
                    this.check = function(o) {
                        for (var h, _, u, c, f, m = s.length, g = m; --m > -1;)(h = p[s[m]] || new d(s[m], [])).gsClass ? (a[m] = h.gsClass, g--) : o && h.sc.push(this);
                        if (0 === g && r)
                            for (u = (_ = ("com.greensock." + e).split(".")).pop(), c = l(_.join("."))[u] = this.gsClass = r.apply(r, a), n && (i[u] = c, !(f = "undefined" != typeof module && module.exports) && "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + e.split(".").pop(), [], (function() {
                                    return c
                                })) : "TweenMax" === e && f && (module.exports = c)), m = 0; this.sc.length > m; m++) this.sc[m].check()
                    }, this.check(!0)
                },
            ...
            (n = w.prototype).addEventListener = function(t, e, i, s, r) {
                ...
                var n, l, h = this._listeners[t],
                    _ = 0;
                for (null == h && (this._listeners[t] = h = []), l = h.length; --l > -1;)(n = h[l]).c === e && n.s === i ? h.splice(l, 1) : 0 === _ && r > n.pr && (_ = l + 1);
                h.splice(_, 0, {
                    c: e,
                    s: i,
                    up: s,
            ...
            g("Ticker", (function(t, e) {
                ...
                w.call(h), h.time = h.frame = 0, h.tick = function() {
                    ...
                    null != r && (f && O ? O(r) : clearTimeout(r), s = c, r = null, h === a && (o = !1))
                }, h.wake = function() {
                    null !== r ? h.sleep() : h.frame > 10 && (k = S() - p + 5), s = 0 === i ? c : f && P ? P : function(t) {
            ...
            A(), n.play = function(t, e) {
                ...
                if (this._timeline) {
                    ...
                    this._gc && this._enabled(!0, !1), (this._totalTime !== t || 0 === this._duration) && (z.length && G(), this.render(t, e, !1), z.length && G())
                }
                return this
            ...
            (n = C.prototype = new R).constructor = C, n.kill()._gc = !1, n._first = n._last = n._recent = null, n._sortChildren = !1, n.add = n.insert = function(t, e) {
                var i, s;
            ...
            (n = D.prototype = new R).constructor = D, n.kill()._gc = !1, n.ratio = 0, n._firstPT = n._targets = n._overwrittenProps = n._startAt = null, n._notifyPluginsOfEnabled = n._lazy = !1, D.version = "1.18.0", D.defaultEase = n._ease = new T(null, null, 1, 1), D.defaultOverwrite = "auto", D.ticker = a, D.autoSleep = 120, D.lagSmoothing = function(t, e) {
                a.lagSmoothing(t, e)
            ...
            var z = [],
                ...
                N = function(t, e, i, s) {
                    var r, n, a, o, l, h, _, u = [t, e],
                        ...
                        f = "",
                        p = 0;
                    for (u.start = t, i && (i(u), t = u[0], e = u[1]), u.length = 0, r = t.match(I) || [], n = e.match(I) || [], s && (s._next = null, s.blob = 1, u._firstPT = s), l = n.length, o = 0; l > o; o++) _ = n[o], f += (h = e.substr(c, e.indexOf(_, c) - c)) || !o ? h : ",", c += h.length, p ? p = (p + 1) % 5 : "rgba(" === h.substr(-5) && (p = 1), _ === r[o] || o >= r.length ? f += _ : (f && (u.push(f), f = ""), a = parseFloat(r[o]), u.push(a), u._firstPT = {
                        _next: u._firstPT,
                        t: u,
                        p: u.length - 1,
                        s: a,
                ...
                L = function(t, e, i, s, r, n, a, o) {
                    ...
                    return "number" !== _ && ("function" === _ && "get" === i && (l = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3), c.s = h = a ? t[l](a) : t[l]()), "string" == typeof h && (a || isNaN(h)) ? (c.fp = a, c = {
                        ...
                        n: r || e,
                        pr: 0
                    }) : u || (c.c = parseFloat(s) - parseFloat(h) || 0)), c.c ? ((c._next = this._firstPT) && (c._next._prev = c), this._firstPT = c, c) : void 0
                },
                E = D._internals = {
                    isArray: f,
                    isSelector: M,
            ...
            W._startTime = a.time, q._startTime = a.frame, W._active = q._active = !0, setTimeout(G, 1), R._updateRoot = D.render = function() {
                var t, e, i;
                if (z.length && G(), W.render((a.time - W._startTime) * W._timeScale, !1, !1), q.render((a.frame - q._startTime) * q._timeScale, !1, !1), z.length && G(), a.frame >= Z) {
                    for (i in Z = a.frame + (parseInt(D.autoSleep, 10) || 120), B) {
            ...
            var $ = function(t, e, i) {
                ...
                H = function(t, e, i, s, r) {
                    ...
                    var h, u = e._startTime + _,
                        ...
                        f = 0,
                        p = 0 === e._duration;
                    for (n = r.length; --n > -1;)(o = r[n]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || K(e, 0, p), 0 === K(o, h, p) && (c[f++] = o)) : u >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > u && ((p || !o._initted) && 2e-10 >= u - o._startTime || (c[f++] = o)));
                    for (n = f; --n > -1;)
            ...
            n._init = function() {
                ...
                if (n.startAt) {
                    ...
                    if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                        ...
                        for (s in 0 !== this._time && (l = !1), i = {}, n) U[s] && "autoCSS" !== s || (i[s] = n[s]);
                ...
                var n, a, o, l, h, _;
                if (null == e) return !1;
                for (n in F[e._gsTweenID] && G(), this.vars.css || e.style && e !== t && e.nodeType && Y.css && !1 !== this.vars.autoCSS && function(t, e) {
                        var i, s = {};
                    ...
                    else if (Y[n] && (l = new Y[n])._onInitTween(e, this.vars[n], this)) {
                    for (this._firstPT = h = {
                            _next: this._firstPT,
                            t: l,
                            p: "setRatio",
                ...
                if (null == t) return [];
                var i, s, r, n;
                if (t = "string" != typeof t ? t : D.selector(t) || t, (f(t) || M(t)) && "number" != typeof t[0]) {
            ...
            if (n = J.prototype, J.version = "1.18.0", J.API = 2, n._firstPT = null, n._addTween = L, n.setRatio = X, n._kill = function(t) {
