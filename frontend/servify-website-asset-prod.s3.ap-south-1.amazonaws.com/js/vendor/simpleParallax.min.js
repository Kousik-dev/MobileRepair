    ...
    return (i = {}, t.m = e = [function(t, e, i) {
        ...
        var l = function() {
            function t(e, i) {
                ! function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), this.element = e, this.elementContainer = e, this.settings = i, this.isVisible = !0, this.isInit = !1, this.oldTranslateValue = -1, this.init = this.init.bind(this),
                    function(t) {
                        return !(!t || !t.complete || void 0 !== t.naturalWidth && 0 === t.naturalWidth)
                    }(e) ? this.init() : this.element.addEventListener("load", this.init)
            }
            return function(t, e, i) {
                e && a(t.prototype, e)
            }(t, [{
            ...
            g = function() {
                ...
                return function(t, e, i) {
                    ...
                    value: function() {
                        ...
                        h = d.length, p || (this.proceedRequestAnimationFrame(), window.addEventListener("resize", this.resizeIsDone), p = !0)
                    }
                }, {
                    key: "resizeIsDone",
                    value: function() {
                        clearTimeout(f), f = setTimeout(this.handleResize, 500)
                    }
                }, {
                    key: "handleResize",
                    value: function() {
                        s.setViewportAll(this.customContainer);
                        for (var t = h - 1; 0 <= t; t--) d[t].getElementOffset(), d[t].getRangeMax();
                        this.lastPosition = -1
                    }
                }, {
                    ...
                    value: function() {
                        if (s.setViewportTop(this.customContainer), this.lastPosition !== s.positions.top) {
                            s.setViewportBottom();
                            for (var t = h - 1; 0 <= t; t--) this.proceedElement(d[t]);
                            c = window.requestAnimationFrame(this.proceedRequestAnimationFrame), this.lastPosition = s.positions.top
                        } else c = window.requestAnimationFrame(this.proceedRequestAnimationFrame)
                    }
                }, {
                    key: "proceedElement",
                    value: function(t) {
                    ...
                    value: function() {
                        ...
                        for (var i = e.length - 1; 0 <= i; i--) e[i].unSetStyle(), !1 === this.settings.overflow && e[i].unWrapElement();
                        (h = d.length) || (window.cancelAnimationFrame(c), window.removeEventListener("resize", this.handleResize))
                    }
                }]), t
            }()
