! function(e, t) {
    ...
    var X = {
            ...
            events: {
                attachEvents: function() {
                    var t = this.params,
                        ...
                        s = this.el,
                        a = this.wrapperEl;
                    this.onTouchStart = I.bind(this), this.onTouchMove = D.bind(this), this.onTouchEnd = O.bind(this), t.cssMode && (this.onScroll = H.bind(this)), this.onClick = G.bind(this);
                    var r = !!t.nested;
                    if (!o.touch && o.pointerEvents) s.addEventListener(i.start, this.onTouchStart, !1), e.addEventListener(i.move, this.onTouchMove, r), e.addEventListener(i.end, this.onTouchEnd, !1);
                        ...
                        if (o.touch) {
                            ...
                            s.addEventListener(i.start, this.onTouchStart, n), s.addEventListener(i.move, this.onTouchMove, o.passiveListener ? {
                                passive: !1,
                                capture: r
                            } : r), s.addEventListener(i.end, this.onTouchEnd, n), i.cancel && s.addEventListener(i.cancel, this.onTouchEnd, n), B || (e.addEventListener("touchstart", N), B = !0)
        ...
        F = function(e) {
            function t() {
                ...
                var p = n.extend({}, X);
                h.useModulesParams(p), h.params = n.extend({}, p, Y, r), h.originalParams = n.extend({}, h.params), h.passedParams = n.extend({}, r), h.$ = s;
                var c = s(h.params.el);
                if (a = c[0]) {
                    if (c.length > 1) {
                        var u = [];
        ...
        le = {
            ...
            setTranslate: function(e, t) {
                ...
                if (Array.isArray(r))
                    for (var o = 0; o < r.length; o += 1) r[o] !== t && r[o] instanceof F && n(r[o]);
            ...
            setTransition: function(e, t) {
                ...
                if (Array.isArray(a))
                    for (i = 0; i < a.length; i += 1) a[i] !== t && a[i] instanceof F && r(a[i]);
    ...
    return void 0 === F.use && (F.use = F.Class.use, F.installModule = F.Class.installModule), F.use(be), F
}));